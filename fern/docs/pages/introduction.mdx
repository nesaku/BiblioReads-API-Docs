...
| `POST /api/works/questions` | questions-scraper | Scrape community Q&A questions for a specific book |
| `POST /api/works/quotes` | quotes-scraper | Scrape quotes associated with a specific book work |